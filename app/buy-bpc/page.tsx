...
export default function BuyBPCPage() {
  ...
  const handlePay = () => {
    ...
    alert("Payment processing... Your BPC code will be displayed once payment is confirmed.")
  }
      ...
      <main className="px-4 py-6 max-w-2xl mx-auto">
        ...
        <div className="bg-white border-l-4 border-[#0000FF] rounded-lg p-4 mb-6">
          <p className="text-gray-700 mb-1">
            Welcome back, <span className="font-semibold text-[#0000FF]">{userData.fullName}</span>
          </p>
          <p className="text-sm text-gray-600">
            Email: <span className="text-[#0000FF]">{userData.email}</span>
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <Input
              ...
              disabled
              className="w-full text-lg bg-gray-100 border-gray-200"
            />
          </div>
